...
/// <summary>
/// V1.4.3 adds maintenance / repair / warranty history without changing existing
/// device or assignment records. The upgrade is idempotent and safe to run at every start.
/// </summary>
public static class SchemaUpgradeV143
{
